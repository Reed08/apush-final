...
function NavigationMenu({
  ...
  return (
    <NavigationMenuPrimitive.Root
      ...
      className={cn(
        'group/navigation-menu relative flex max-w-max flex-1 items-center justify-center bg-card',
        className
      )}
      {...props}
    >
...
function NavigationMenuLink({ className, ...props }: React.ComponentProps<typeof NavigationMenuPrimitive.Link>) {
  return (
    <NavigationMenuPrimitive.Link
      ...
      className={cn(
        "flex items-center gap-1.5 rounded-sm px-2 pb-0.5 pt-1 text-sm text-muted-foreground hover:text-foreground transition-colors outline-none border-b-2 border-transparent focus-visible:ring-[3px] focus-visible:ring-ring/50 focus-visible:rounded-sm in-data-[slot=navigation-menu-content]:rounded-lg data-active:text-primary data-active:border-primary [&_svg:not([class*='size-'])]:size-4",
        className
      )}
      {...props}
    />
